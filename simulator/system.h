...
class System {
  ...
  private:
    ...
    // Buffers
    stringstream _out_buffer;
    stringstream _kinetic_buffer;
    stringstream _potential_buffer;
    stringstream _total_buffer;
    stringstream _temperature_buffer;
    stringstream _pressure_buffer;
    stringstream _magnet_buffer;
    stringstream _cv_buffer;
    stringstream _chi_buffer;
    stringstream _a_buffer;
    stringstream _gofr_buffer; //this one is not inherited by successive cycles
  ...
  public:                                           // Function declarations
    ...
    void initialize(int index, string name);        // Initialize system properties
    void initialize_properties(bool verbose);       // Initialize properties for measurement
    ...
    void initialize_buffer(string buf, int which);  // Initialize buffers
    string print_buffer(int which) const;
