...
class System {
  ...
  private:
    ...
    stringstream kinetic_buffer;
    stringstream potential_buffer;
    stringstream total_buffer;
    stringstream temperature_buffer;
    stringstream pressure_buffer;
    stringstream a_buffer;
